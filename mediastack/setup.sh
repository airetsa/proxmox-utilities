...
mkdir -p /opt/mediastack/{config/{jellyfin,lidarr,prowlarr,sonarr,radarr,bazarr,qbittorent,filebrowser,gluetun},downloads/{tv,music,movies},media/{tv,music,movies}}
